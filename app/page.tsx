    ...
    <main className="min-h-screen overflow-x-hidden" style={{background: '#0e0e0e', color: '#f0ebe0'}}>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-16 items-start max-w-6xl" style={{zIndex: 2}}>
          <div>
            <h2 style={{
              ...
              TRUTH HAS NEVER<br/>
              <span style={{color: '#9e2230'}}>NEEDED PERMISSION</span>
            </h2>
      ...
      <section id="podcast" className="py-28 px-8 md:px-16 lg:px-24" style={{background: '#0a0a0a', borderTop: '1px solid rgba(240,235,224,0.06)'}}>
        ...
        <div className="flex items-center gap-3 mb-14">
          ...
          <span style={{fontFamily: 'var(--font-oswald), sans-serif', fontSize: '0.68rem', letterSpacing: '0.35em', color: '#9e2230', fontWeight: 500}}>THE PODCAST</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl">
          <div>
            <h2 style={{
              ...
              <span style={{color: '#9e2230'}}>AMERICA NEEDS</span>
            </h2>
          ...
          <div style={{border: '1px solid rgba(240,235,224,0.08)', position: 'relative', padding: '2rem'}}>
            <div style={{position: 'absolute', top: 0, left: 0, width: '2px', height: '100%', background: '#9e2230', opacity: 0.7}}></div>
            <div style={{
              width: '100%',
              aspectRatio: '1',
              ...
              <div style={{textAlign: 'center', position: 'relative', zIndex: 1}}>
                ...
                <div style={{width: '40px', height: '2px', background: '#9e2230', margin: '0.75rem auto'}}></div>
                <div style={{
                  fontFamily: 'var(--font-oswald), sans-serif',
                  fontSize: '0.6rem',
      ...
      {/* ── JOIN ── */}
      <section id="join" className="relative py-28 px-8 md:px-16 lg:px-24 overflow-hidden" style={{background: '#0e0e0e', borderTop: '1px solid rgba(158,34,48,0.2)'}}>

        {/* Subtle red wash */}
        <div style={{
          position: 'absolute', inset: 0,
          background: 'radial-gradient(ellipse at 50% 100%, rgba(158,34,48,0.07), transparent 70%)',
          pointerEvents: 'none',
        }}></div>
        ...
        <div className="relative max-w-3xl">
          <div className="flex items-center gap-3 mb-10">
            <div style={{width: '2px', height: '1.1rem', background: '#9e2230'}}></div>
            <span style={{fontFamily: 'var(--font-oswald), sans-serif', fontSize: '0.68rem', letterSpacing: '0.35em', color: '#9e2230', fontWeight: 500}}>JOIN THE MOVEMENT</span>
          </div>
          ...
          <h2 style={{
            ...
            THIS IS YOUR<br/>
            <span style={{color: '#9e2230'}}>COUNTRY TOO.</span>
          </h2>
